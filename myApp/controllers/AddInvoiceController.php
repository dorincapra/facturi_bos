    ...
    public function init()
    {
        ...
        if ($_POST['existentClient'] == "") {
            ...
            if ($client->addClient($clientName, $clientCUI, $clientJ, $clientContactP, $clientPhone, $clientEmail, $clientLocation, $clientIBAN)) {
                ...
                $data['test'] = "n-a mers la client";
            }
        } else {
            $clientID = $client->getClientID($_POST['existentClient'])[0]['id'];
        }
       ...
       // $data['test'] = $client->getClientID($_POST['existentClient'])[0]['id'];
       // $data['test'] = var_dump($_POST['existentClient']);
