...
class ShowInvoicesController extends AppController
{
  ...
  public function init()
  {
    ...
    if (isset($_POST['nrFactura']) || isset($_POST['emitedFrom']) || isset($_POST['emitedUntil']) || isset($_POST['invoiceStatus']) || isset($_POST['termFrom']) || isset($_POST['termUntil']) || isset($_POST['signed']) || isset($_POST['paidFrom']) || isset($_POST['paidUntil']) || isset($_POST['currency']) || isset($_POST['agent']) || isset($_POST['status'])) {
